...
// EffectType.displayName, MaskShape.displayName, and TransitionType.displayName
// have been moved to Sources/MovieCutCore/Models/DisplayNames.swift so they are
// available to both Mac and iOS targets.
