...
struct IOSEffectsInspectorView: View {
    @ObservedObject var viewModel: IOSEditorViewModel
    let clip: Clip
    ...
    private var colorCorrectionSection: some View {
        ...
        return VStack(alignment: .leading, spacing: 8) {
            ...
            inspectorSlider(title: "밝기", value: cc.brightness, range: -1...1)
            inspectorSlider(title: "대비", value: cc.contrast, range: 0...2)
            inspectorSlider(title: "채도", value: cc.saturation, range: 0...2)
            inspectorSlider(title: "색온도", value: cc.warmth, range: -1...1)
        }
    }
    ...
    private var maskSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            if let mask = clip.mask {
                ...
                inspectorSlider(title: "페더", value: mask.feather, range: 0...1)
            } else {
                Text("마스크 없음")
                    .font(.caption)
                    .foregroundStyle(.secondary)
    ...
    private func inspectorSlider(title: String, value: Double, range: ClosedRange<Double>) -> some View {
