...
/// Renders a still image into a self-contained H.264 video segment so image
/// clips can ride the regular composition pipeline. Shared by the Mac and iOS
/// render paths so photo clips render identically on both platforms
/// (G-15). EXIF orientation is baked upright at load
/// (kCGImageSourceCreateThumbnailWithTransform).
public final class ImageVideoRenderService: Sendable {
...
public enum ImageVideoRenderServiceError: LocalizedError, Sendable {
