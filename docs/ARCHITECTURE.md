...
| [`TransitionPixelProcessor`](file:///Users/cool-mini4/MyDev/automation/movie_cut/Sources/MovieCutCore/Rendering/TransitionPixelProcessor.swift) | 인접 클립 간 11종 Two-source 화면 전환 (Cross Dissolve, Fade Through Black, Wipe×4, Slide×2, Zoom×2, Glitch — `TransitionType` 구체 케이스 기준, 2026-08-22 코드 확인. `basic/wipe/slide/zoom/stylized`는 범주 라벨). |
