...
> 버전: 1.7 / 작성일: 2026-07-06 / 기준 대상: **CapCut 데스크톱(Mac/PC) 2026 버전**
...
| **프록시 소비 미배선 (B-I7)** | 있음 [확인] | 🟡 **배선 격차** — `ProxyInfo` 존재, `PlaybackEngine`·`ExportEngine` 참조 **각 0회** | G-11에 귀속, V13 §3-B |
...
| B-I 동작 | — | 3 | 3 (I1/I4/**I7**) | I8 (0파일) | I7 = 프록시 소비 **0회** 확정 |
