...
| CA-04 | 입력 포맷 호환 매트릭스(VFR·10bit·Log·혼합 fps/sample rate·rotation) | P0 | **완료(2026-08-24) — `AUDIT_INPUT_FORMATS_20260824.md` + `run_ca04_format_matrix.sh` 실측: VFR→CFR✅·혼합 fps A/V Δ0ms✅·BT.2020→bt709 재태그✅·10bit near-black(BUG-06 등록)·회전 미실증(BUG-07 등록)** | 매트릭스 작성 + 최우선 회귀(혼합 미디어 sync·색 유지) 실측 |
