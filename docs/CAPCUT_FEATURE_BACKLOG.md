...
**CapCut 대비 완성도 재평가(2026-07-05 loop-6, 기준 `fe9b062`)**: 최신 분석 문서는 `docs/GAP_ANALYSIS_V9_FUNC_UI_20260705.md`다. 52주기식 자가보고 97%는 계속 폐기한다. G-12가 8/14로 증가(#1 EQ, #2 NR, #3 덕킹, #4 모션 트래킹, #5 옵티컬 플로우, #6 텍스트 애니메이션, #8 플랫폼 프리셋, #10 오디오 추출)하면서 체감 완성도는 68~74%로 소폭 상향 가능하나, 아직 “능가” 선언은 금지다. 미완 핵심은 (1) G-02 HSL/커브 렌더 체이닝+저장+UI+iOS, (2) G-01 caption style model+active-word renderer+preview/export+iOS, (3) G-12 잔여 6개(#7/#9/#11/#12/#13/#14), (4) G-04 필름스트립, G-05 보컬분리/보이스FX, G-06 이징 UI, G-09 iOS 본대, (5) U-01/U-02/U-04/U-05/U-06/U-08/U-09 UI 표면이다.
