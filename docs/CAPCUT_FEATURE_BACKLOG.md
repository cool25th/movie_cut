...
**실행 규칙**: CA-01·02·03·04·05·06·08·12·14·15·17·19·22·24·26·27·28는 즉시 실행(03~06은 2026-08-24 방향 문서 §3 v1.1 반영으로 자격 확보), CA-18·21은 측정 단계만, CA-20·23·25는 등록 완료(실행 조건 도달 시), 나머지는 승인 대기. AI 음성(TTS 보이스 확장)은 **등록 보류(2026-08-23 승인 — 베타 반응 후 재상정)**. 루프 회차 보고에는 '승인 대기' 항목을 항상 나열한다.
