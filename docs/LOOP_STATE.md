...
다음 증분(우선순위): ① **CANVAS-01** 캔버스·배경 상시 composition 반영 + 비율별 골든 ② BUG-IOS-06 공통 임포터 통합 ③ AUTOSAVE-02 직렬화+UI ④ MACUI-01 러너 복구·CI 차단화 ⑤ BUG-07 회전·G-27 실기기. **PARITY-TOL-01 승인 대기 유지**. RENDER-02(P2 디코드 luma 드리프트) 등록.
