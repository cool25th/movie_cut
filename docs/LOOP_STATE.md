...
검증 증거: 구현 커밋 `fdcf8adf0e03fd925aa06264af6000415f399dcf`; PR CI #87(`32503478653`)에서 `build-and-test` ✅ / `ios-tests` ✅ / `lint` ✅. Core catalog 행동 테스트는 preview 가능 효과만 노출, renderer parameter key, 비중립 preview 시작값, range 안전성, unknown-key 제거/override clamp를 고정. Mac app build와 generic iOS build도 green.
