...
M2 진행 현황: F-07(전환 visual fixture)은 별도 세션 진행 중. **F-11 캔버스 배경은 구현+테스트+배선 완료(🟡, 실기기/픽스처 잔여 — 스펙 F-11 검증 기록 참조)**. 다음 후보: F-09 외부 LUT(단, InspectorEffectsSection이 F-07 세션과 충돌 가능 — 선점 확인), F-10 크로마키 스포이드, F-08 배경제거 E2E.
